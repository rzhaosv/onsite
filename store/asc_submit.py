"""Attach newest processed build to Cutoff 1.0, create a review submission with version + subs + group version, submit.
Run: cd landed/.credentials && PYTHONPATH=. python3 ~/workspace/onsite/store/asc_submit.py [--dry-run]"""
import asc, json, sys, time
APP='6809073495'; GROUP='22362505'; SUBS=['6809073904','6809074565']; DRY='--dry-run' in sys.argv
